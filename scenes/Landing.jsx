...
import profilePic from '../assets/logoFoodie.png';
    ...
    >
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          <img
            alt="profile"
            className="z-10 w-full max-w-[400px] md:max-w-[600px] rounded-t-lg"
            src={profilePic}
          />
        )}
      </div>
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            {translation.elevateYourGastronomicBusiness}
          </p>
        </motion.div>
